        ...
        <div class="col-lg-12 margin-tb">
            <div class="card card-mini">
                ...
                <div class="card-body">
                    ...
                    {!! Form::open(array('route' => 'logos.store','method'=>'POST', 'enctype' => 'multipart/form-data')) !!}
                            ...
                            <div class="form-group imageUpload">
                                ...
                                <div class="input-group">
                                    <span class="input-group-btn">
                                        <a id="image" data-input="cover_thumbnail" data-preview="cover_preview"
                                ...
                                <script>$('#image').filemanager('file', '', false);</script>
                            </div>
                        </div>
                    </div>

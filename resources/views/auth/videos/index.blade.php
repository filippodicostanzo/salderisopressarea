                                    ...
                                    <td>
                                        @if (str_contains($host,'youtu'))
                                            <div class="cover-thumbnail"
                                                 style="background-image: url('//img.youtube.com/vi/{{$id}}/0.jpg')"></div>
                                            @else
                                            <div class="cover-thumbnail"
                                                 style="background-image: url('//vumbnail.com/{{$id}}.jpg')"></div>
                                        @endif
                                    ...
                                    <td align="right">
                                        <div class="btn-group">
                                            <a class="btn btn-default btn-xs"
                                               href="{{ route('videos.show',$item->id_code) }}">
                                                <i class="fas fa-eye fa-1x fa-lg" aria-hidden="true"></i>
                                            </a>
                                            <a class="btn btn-default btn-xs"
                                               href="{{ route('videos.edit', $item->id_code) }}">
                                                <i class="fas fa-pencil-alt fa-1x fa-lg" aria-hidden="true"></i>
                                            </a>
                                            {!! Form::open(['method' => 'DELETE','route' => ['videos.destroy', $item->id_code],'style'=>'display:inline']) !!}

        ...
        <div class="col-lg-12 margin-tb">
            <div class="card card-mini">
                ...
                <div class="card-body">
                    ...
                    {!! Form::model($item, ['method' => 'PATCH','route' => ['videos.update', $item->id_code], 'enctype' => 'multipart/form-data'] ) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-md-3">
                            <div class="form-group">
                                ...
                                {!! Form::text('url', null, array('placeholder' => 'https://www.youtube.com/fQY16Zg2ikw','class' => 'form-control')) !!}
                            </div>
                        </div>

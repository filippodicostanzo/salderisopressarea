                        ...
                        <div class="col-md-12 col-xs-12 center">
                            <div class="form-group">
                                ...
                                <div class="input-group-btn">
                                    ...
                                    {{ Form::hidden('images', '', array('id' => 'images')) }}
                                    <ul id="holder" style="margin-top:15px"></ul>

                                    <script>
                                        $('#lfm').filemanager('file', '', true);
                                        $('#holder').sortable(
                                            {
                                                update: function () {

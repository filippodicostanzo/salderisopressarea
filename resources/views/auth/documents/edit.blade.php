        ...
        <div class="col-lg-12 margin-tb">
            <div class="card card-mini">
                ...
                <div class="card-body">
                    ...
                    {!! Form::model($item, ['method' => 'PATCH','route' => ['documents.update', $item->id_code], 'enctype' => 'multipart/form-data'] ) !!}
                            ...
                            <div class="col-xs-6 col-md-3">
                                <div class="form-group imageUpload">
                                    ...
                                    <span class="input-group-btn">
                                        ...
                                        {!! Form::text('file', null, array('placeholder' => 'Image','class' => 'form-control file-src','id' => 'cover_thumbnail')) !!}
                                    </div>
